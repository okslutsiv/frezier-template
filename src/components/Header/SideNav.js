...
class SideNav extends React.Component {
  ...
  onTouchEnd(e) {
    ...
    const translateX = Math[openFromRight ? "max" : "min"](
      0,
      this.currentX - this.startX,
    );
    ...
    let handleItemHover = (e, enter) => {
      if (enter)
        Object.assign(
          ...
          styles.li,
          this.props.itemHoverStyle || { backgroundColor: "#f5f5f5" },
        );
      else Object.assign(e.currentTarget.style, styles.li);
    };
  ...
  getStyle() {
    ...
    let styles = {
      ...
      nav: {
        ...
        transform: showNav
          ? "none"
          : `translateX(${openFromRight ? 102 : -102}%)`,
